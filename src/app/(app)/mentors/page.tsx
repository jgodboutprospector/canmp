...
import MentorTeamsList from '@/components/modules/mentors/MentorTeamsList';

const tabs = [
  { name: 'Teams', href: '/mentors', icon: Heart },
  { name: 'Volunteers', href: '/mentors/volunteers', icon: Users },
];
