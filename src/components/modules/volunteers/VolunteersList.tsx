...
import { ImportFromNeonModal } from './ImportFromNeonModal';
...
export default function VolunteersList() {
  ...
  const { volunteers, loading, error, refetch } = useVolunteers({ search });
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-5 gap-4 mb-6">
        ...
        <div className="card p-4">
          ...
          <p className="text-2xl font-semibold text-amber-600">{totalHours.toFixed(1)}</p>
        </div>
      </div>
