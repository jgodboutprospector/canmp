        ...
        {showDeleteConfirm && (
          <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-center gap-2 text-red-700 mb-2">
              ...
              <span className="font-medium">Delete Beneficiary?</span>
            </div>
            <p className="text-sm text-red-600 mb-3">
              This will permanently delete {beneficiary.first_name} {beneficiary.last_name} and all associated records.
